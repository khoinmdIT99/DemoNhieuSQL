...
namespace Demo.Areas.FirstStart.Extensions
{
    ...
    public static class StartupExtensions
    {
        ...
        private static IServiceCollection AddRepositories(this IServiceCollection services, IConfiguration config)
        {
            ...
            const string SqlServerConnection = ConnectinStrings.SqlServerConnection;
            const string InMemoryConnection = ConnectinStrings.InMemoryConnection;
            const string PostgreSQLConnection = ConnectinStrings.PostgreSQLConnection;
            const string SQLiteConnection = ConnectinStrings.SQLiteConnection;
