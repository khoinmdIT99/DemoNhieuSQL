...
namespace Demo.Areas.FirstStart.Extensions
{
    ...
    public static class StartupExtensions
    {
        ...
        private static IServiceCollection AddRepositories(this IServiceCollection services, IConfiguration config)
        {
            ...
            string SqlServerConnection = ConnectinStrings.SqlServerConnection;
            string InMemoryConnection = ConnectinStrings.InMemoryConnection;
            string PostgreSQLConnection = ConnectinStrings.PostgreSQLConnection;
            string SQLiteConnection = ConnectinStrings.SQLiteConnection;
