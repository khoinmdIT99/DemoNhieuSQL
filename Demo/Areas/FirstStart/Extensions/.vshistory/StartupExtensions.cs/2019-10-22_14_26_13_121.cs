...
namespace Demo.Areas.FirstStart.Extensions
{
    ...
    public static class StartupExtensions
    {
        ...
        public static IApplicationBuilder UseFirstStartConfiguration(this IApplicationBuilder app, Func<Task> restartHost)
        {
            ...
            //    //_IsAdminUserCreated = Configuration.GetValue<bool>(ConstStrings.IsFirstStart);

            //    //_IsAdminUserCreated = context.Roles.AsNoTracking().Where(r => r.Name.Equals(Administrators, StringComparison.OrdinalIgnoreCase)).Any();
            //    //UserManager<IdentityUser> userManager = serviceProvider.GetRequiredService<UserManager<IdentityUser>>();
            //    //var ur = userManager.GetUsersInRoleAsync(Administrators).GetAwaiter().GetResult();
        ...
        private static bool IsFirstStartIncomplete(HttpContext context)
        {
            ...
            return configuration.GetValue<bool>(ConstStrings.IsFirstStart);
        }
