...
namespace Demo.Areas.FirstStart.Extensions
{
    ...
    public static class StartupExtensions
    {
        ...
        private static readonly string DataProvider = ConstStrings.DataProvider;
        private static readonly string Administrators = ConstStrings.Administrators;
        private static readonly string FirstStart = ConstStrings.FirstStart;
