...
namespace Demo.Areas.FirstStart.Pages
{
    public class IndexModel : PageModel
    {
        ...
        {
            if (string.IsNullOrEmpty(firstStartConfiguration.Database) || string.IsNullOrEmpty(firstStartConfiguration.ConnectionString))
            {
                FirstStartConfig.ConnectionString = Config.GetConnectionString(ConstStrings.SqlServerConnection);
                FirstStartConfig.Database = Config.GetConnectionString(ConstStrings.DataProvider);
            }
